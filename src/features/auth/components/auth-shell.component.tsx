...
export function AuthShell({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.22),_transparent_36%),linear-gradient(135deg,_#f8fbff_0%,_#eef6ff_45%,_#fef7ed_100%)]">
      ...
      <div
        className={cn(
          "relative mx-auto flex min-h-screen max-w-6xl items-center justify-center px-4 sm:px-6 lg:px-8",
          compact ? "py-4 sm:py-5" : "py-10"
        )}
      >
        <Card
          className={cn(
            "w-full max-w-[36rem] rounded-[32px] border-white/70 bg-white/82 shadow-[0_24px_80px_rgba(15,23,42,0.14)] backdrop-blur",
